/* 
 * frame.c - Homeplug 1.0 and AV ethernet frame handling and operations
 * 
 ...
 *
 * Description:
 *	Provide all the frame specific operations on Ethernet
 *	frames and the network high-level operations
 * 
 * License:
 *	GPLv2
 */
